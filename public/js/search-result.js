    ...
    <ul class="list-unstyled m-0">
        <li>
            <a href="#" class="text-decoration-none text-dark">
                <div class="row" >
                    <div class="card container d-flex flex-row m-2 p-0 gap-2">
                        <img class="result-image" src="static/assets/user_pfp/bhozx_josh.png" alt="">
                        <div class="result-info d-flex flex-column w-90">
        ...
        <li>
            <a href="#" class="text-decoration-none text-dark">
                <div class="row" >
                    <div class="card container d-flex flex-row m-2 p-0 gap-2">
                        <img class="result-image" src="static/assets/user_pfp/errol09.png" alt="">
                        <div class="result-info d-flex flex-column w-90">
        ...
        <li>
            <a href="#" class="text-decoration-none text-dark">
                <div class="row" >
                    <div class="card container d-flex flex-row m-2 p-0 gap-2">
                        <img class="result-image" src="static/assets/user_pfp/jstn.png" alt="">
                        <div class="result-info d-flex flex-column w-90">
        ...
        <li>
            <a href="#" class="text-decoration-none text-dark">
                <div class="row" >
                    <div class="card container d-flex flex-row m-2 p-0 gap-2">
                        <img class="result-image" src="static/assets/user_pfp/jomarzkii.png" alt="">
                        <div class="result-info d-flex flex-column w-90">
        ...
        <li>
            <a href="#" class="text-decoration-none text-dark">
                <div class="row" >
                    <div class="card container d-flex flex-row m-2 p-0 gap-2">
                        <img class="result-image" src="static/assets/user_pfp/qwerty.png" alt="">
                        <div class="result-info d-flex flex-column w-90">
